...
class forgot_password_otp: UIViewController, UITextFieldDelegate {
    
    var str_toast_alert:String!
    ...
    override func viewDidLoad() {
        ...
        self.view.makeToast(String(str_toast_alert))
...
//MARK:- TABLE VIEW -
extension forgot_password_otp: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:forgot_password_otp_table_cell = tableView.dequeueReusableCell(withIdentifier: "forgot_password_otp_table_cell") as! forgot_password_otp_table_cell
        ...
        cell.txt_otp.delegate = self
        
        cell.txt_otp.placeholder = text_language.change_password_screen(status: "#06")
        ...
        cell.txt_otp.becomeFirstResponder()
