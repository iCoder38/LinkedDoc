...
class loginViewController: UIViewController {
    ...
    @objc func convert_language() {
        ...
        self.btn_doctor.setTitle(text_language.login_screen(status: "#03"), for: .normal)
        self.btn_patient.setTitle(text_language.login_screen(status: "#04"), for: .normal)
        self.lbl_message.text = text_language.login_screen(status: "#05")
